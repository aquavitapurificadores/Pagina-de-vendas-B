...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-snow font-sans text-text-main selection:bg-sapphire/20">
      ...
      <a
        href="https://wa.me/5554999997286?text=Ol%C3%A1,%20estava%20na%20p%C3%A1gina%20da%20AquaVita%20e%20gostaria%20de%20falar%20com%20um%20especialista"
        target="_blank"
        rel="noopener noreferrer"
        className="flex md:hidden fixed bottom-6 right-6 z-50 items-center justify-center gap-2 bg-[#25D366] text-white font-medium px-5 py-3 rounded-full shadow-xl shadow-green-900/20 hover:scale-105 transition-transform animate-pulse"
      >
        <svg
